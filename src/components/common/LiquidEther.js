...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update({ dt: nextDt, isBounce: nextBounce, BFECC: nextBfecc }) {
        this.uniforms.dt.value = nextDt;
        this.line.visible = nextBounce;
        this.uniforms.isBFECC.value = nextBfecc;
        super.update();
      }
    }
    ...
    class Viscous extends ShaderPass {
      ...
      update({ viscous: nextViscous, iterations, dt: nextDt }) {
        let fbo_in;
        let fbo_out;
        this.uniforms.v.value = nextViscous;
